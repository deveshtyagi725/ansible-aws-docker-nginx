...
âœ… Provisioned an EC2 instance on AWS  
âœ… Configured Security Groups to open ports `22 (SSH)` and `80 (HTTP)`  
âœ… SSHâ€™d into the instance using a `.pem` key  
âœ… Installed **Docker** to handle container deployment  
âœ… Deployed an **Nginx container** that serves a beautiful custom `index.html` landing page  
âœ… Verified deployment with a live public IP

---

## í¼ Live Demo

í±‰ [Visit the Project Live](http://13.49.238.71)
...
- `README.md` â€“ You're reading it í¸„
